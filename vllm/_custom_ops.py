...
def paged_attention_selected_v1(
    out: torch.Tensor,
    query: torch.Tensor,
    key_cache: torch.Tensor,
    value_cache: torch.Tensor,
    ...
    torch.ops._C.paged_attention_selected_v1(
        out, query, key_cache, value_cache, num_kv_heads, scale, block_tables,
        seq_lens, selected_block_indices, selected_count, block_size,
        selected_seq_len, alibi_slopes, kv_cache_dtype, k_scale, v_scale,
        tp_rank)


def paged_attention_selected_v2(
    out: torch.Tensor,
    exp_sum: torch.Tensor,
    max_logits: torch.Tensor,
    tmp_out: torch.Tensor,
    ...
    torch.ops._C.paged_attention_selected_v2(
        out, exp_sum, max_logits, tmp_out, query, key_cache, value_cache,
        num_kv_heads, scale, block_tables, seq_lens, selected_block_indices,
        selected_count, block_size, selected_seq_len, alibi_slopes,
