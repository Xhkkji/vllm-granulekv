...
if TYPE_CHECKING:
    ...
    VLLM_GRANULEKV_SPARSE_CONSUMER_ENABLE: bool = False
    VLLM_GRANULEKV_SPARSE_RESIDENT_ENABLE: bool = False
    VLLM_GRANULEKV_SPARSE_POLICY_MODULE: Optional[str] = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_GRANULEKV_SPARSE_CONSUMER_ENABLE":
    lambda: bool(int(os.getenv("VLLM_GRANULEKV_SPARSE_CONSUMER_ENABLE", "0"))),
    "VLLM_GRANULEKV_SPARSE_RESIDENT_ENABLE":
    lambda: bool(int(os.getenv("VLLM_GRANULEKV_SPARSE_RESIDENT_ENABLE", "0"))),
    "VLLM_GRANULEKV_SPARSE_POLICY_MODULE":
    lambda: os.getenv("VLLM_GRANULEKV_SPARSE_POLICY_MODULE"),
    "VLLM_GRANULEKV_SPARSE_BLOCK_BUDGET":
    lambda: int(os.getenv("VLLM_GRANULEKV_SPARSE_BLOCK_BUDGET", "0")),
    "VLLM_GRANULEKV_SPARSE_DYNAMIC_RESTORE_ENABLE":
    lambda: bool(
        int(os.getenv("VLLM_GRANULEKV_SPARSE_DYNAMIC_RESTORE_ENABLE", "0"))),
    ...
    "VLLM_GRANULEKV_SPARSE_SELECTED_BLOCKS_ENABLE":
    lambda: bool(
        int(os.getenv("VLLM_GRANULEKV_SPARSE_SELECTED_BLOCKS_ENABLE", "0"))),
